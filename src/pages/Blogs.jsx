        ...
        <div className="flex flex-col items-center relative right-10 gap-y-12">
          {blogs.map((blog, index) => {
            return (
              <div
                className={`${
                  test === index ? "scale-110 h-96 w-2/5" : "h-44 w-2/5"
              ...
              >
                <div className="flex" onClick={() => setTest(index)}>
                  <img
                  ...
                  <p
                    className={`font-bold text-lg- ml-5 transition-all ${
                      test === index ? "opacity-100 mt-12" : "opacity-70 mt-4"
                    }`}
                  >
                ...
                <p
                  ...
                  className={`font-bold text-sm w-full mt-2 ml-5 self-end absolute transition-all  ${
                    test === index ? "top-20 left-44" : "top-3/4 left-2/3"
                  }`}
                >
