  ...
  return (
    <div className="flex items-center relative">
      <img
        ...
        className={
          isChecked
            ? "w-40 min-w-40 h-52 object-cover mr-4 cursor-pointer opacity-75 transition-all bg-[#A59719]"
            : "w-40 min-w-40 h-52 object-cover mr-4 cursor-pointer transition-all bg-[#A59719]"
        }
